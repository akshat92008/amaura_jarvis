...
PRODUCT_TYPES = {"mobile_app", "micro_saas", "web_app", "browser_extension", "developer_tool", "template", "game", "ai_utility"}
...
class VentureStudio:
    ...
    def dashboard(self) -> dict[str, Any]:
        ...
        return {
            ...
            "mission": "Fund Amaura Labs through focused products without turning the lab into an agency",
            "rules": {
