...
CAPABILITY_RULES: dict[str, set[str]] = {
    "plan": {
        ...
        "amaura_company_blueprint", "amaura_resource_inventory", "amaura_capability_health", "amaura_capability_plan", "amaura_execute_capability",
    ...
    "analyse": {
        ...
        "amaura_venture_dashboard", "amaura_record_venture_metric", "amaura_venture_recommendation"
    },
    ...
    "recommend": {"read_file", "recall_memory", "web_fetch", "search_code", "get_project_structure", "analyze_code", "amaura_venture_dashboard", "amaura_venture_recommendation"},
