    ...
    if live:
        ...
        live_checks = {
            ...
            "worker_model_installed": (
                ollama["worker_model_installed"] if model_mode in {"local", "balanced"} else True
            ),
            "reviewer_model_installed": (
                ollama["reviewer_model_installed"] if review_mode == "local" else True
            ),
            "cloud_worker_configured": (
                True if model_mode == "local" else bool(cloud_worker_model and cloud_worker_key)
            ),
            "cloud_reviewer_configured": (
                True if review_mode == "local" else bool(cloud_review_model and cloud_review_key)
            ),
