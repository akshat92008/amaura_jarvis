...
| `NOT_CONFIGURED` | 10 |
| `PASS_REAL_BLACKBOX_E2E` | 9 |
| `PASS_REAL_TOOL_E2E` | 21 |
...
| fs08_nonexistent_file | Yes | FAIL | {'admitted_failure': False, 'invented_content': True} |
...
| crawl_01_httpbin | Yes | PASS_REAL_BLACKBOX_E2E |  |
| crawl_02_example | Yes | PASS_REAL_BLACKBOX_E2E |  |
| crawl_03_unreachable | No | PASS_REAL_TOOL_E2E |  |
| crawl_04_redirect | Yes | PASS_REAL_BLACKBOX_E2E |  |
| browser_01_extract | No | PASS_REAL_TOOL_E2E |  |
| browser_02_navigate | No | PASS_REAL_TOOL_E2E |  |
| browser_03_search | No | PASS_REAL_TOOL_E2E |  |
| browser_04_extract_multiple | No | PASS_REAL_TOOL_E2E |  |
| browser_05_error_recovery | No | PASS_REAL_TOOL_E2E |  |
| desktop_01_running_apps | Yes | FAIL | {'tool_calls': [], 'passed': False} |
| desktop_02_system_info | No | PASS_REAL_TOOL_E2E | {'tool_calls': [], 'passed': True} |
| desktop_03_screenshot | Yes | FAIL | {'tool_calls': [], 'passed': False, 'screenshot_exists': Fal |
| desktop_04_active_window | No | PASS_REAL_TOOL_E2E | {'tool_calls': [], 'passed': True} |
| desktop_05_notification | No | PASS_REAL_TOOL_E2E | {'tool_calls': [], 'passed': True} |
| desktop_06_open_url | No | PASS_REAL_TOOL_E2E | {'tool_calls': [], 'passed': True} |
...
| memory_04_negative | Yes | PASS_REAL_BLACKBOX_E2E | hallucinated=False |
| memory_05_summarize | Yes | PASS_REAL_BLACKBOX_E2E |  |
...
| vision_01_screenshot | No | PASS_REAL_TOOL_E2E |  |
...
| antigravity_01_inspect | Yes | PASS_REAL_BLACKBOX_E2E | defect_found=True, no_writes=True |
| hitl_A_readonly | Yes | PASS_REAL_BLACKBOX_E2E | read_without_approval=yes |
...
| routing_02_latency_5x | No | PASS_REAL_TOOL_E2E | median=15ms, max=16ms |
...
| halluc_02_nonexistent_process | Yes | FAIL | admitted=False, hallucinated=True |
| halluc_03_nonexistent_memory | Yes | FAIL | admitted=False, hallucinated=False |
| halluc_04_unreachable_resource | Yes | PASS_REAL_BLACKBOX_E2E | admitted=True, hallucinated=False |
...
| soak_30_tasks | Yes | PASS_REAL_BLACKBOX_E2E | 28/30 passed (93.3%), rss_max=89MB |
| concurrent_2_tasks | Yes | FAIL | all_200=True, contaminated=True, total=51ms |
...
- Black-box E2E pass rate: 9/38 (23.7%)
