...
class TestVectorMemory(unittest.TestCase):
    ...
    def test_importance_and_hybrid_scoring(self):
        ...
        self.brain.remember(
            "CRITICAL: Always use n1-standard-4 with T4 GPU for model training", category="architecture", importance=9.5
        )
    ...
    def test_search_project_memory(self):
        self.brain.remember(
            "Architecture decision: Use FastAPI and Playwright V2", category="architecture", importance=9.0
        )
