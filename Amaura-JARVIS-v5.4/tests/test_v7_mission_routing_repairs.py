...
def test_explicit_research_with_cli_workspace_is_not_misrouted_to_repository_work(tmp_path, monkeypatch):
    compiler = GoalCompiler()
    monkeypatch.setattr(compiler, "llm_planning_enabled", lambda: False)
    request = GoalRequest(
