...
class LeadWorkflowGraph:
    ...
    def _build_graph(self) -> None:
        ...
        self.graph.add_conditional_edges("validate", self.route_after_validate, {"research": "research", "END": END})

        self.graph.add_edge("research", "qualify")

        self.graph.add_conditional_edges("qualify", self.route_after_qualify, {"draft": "draft", "END": END})

        self.graph.add_edge("draft", "review")

        self.graph.add_conditional_edges("review", self.route_after_review, {"approve": "approve", "draft": "draft"})
