...
READ_ONLY_TOOLS = frozenset(
    {
        ...
        "get_project_structure", "web_search", "web_fetch", "read_pdf",
        "recall_memory", "search_project_memory", "search_symbol",
        "index_codebase_ast", "analyze_code", "git_status",
        "generate_morning_briefing",
        "amaura_company_status", "amaura_company_blueprint",
        "amaura_resource_inventory", "amaura_capability_health", "amaura_capability_plan", "amaura_revenue_dashboard",
        "amaura_list_agents", "amaura_list_tasks", "amaura_task_packet",
        "amaura_supervisor_status", "amaura_pending_approvals",
        "amaura_daily_briefing", "amaura_read_evidence",
        "amaura_get_campaign_context", "amaura_venture_dashboard", "amaura_cashflow_dashboard",
...
GOVERNED_ONLY_TOOLS = frozenset(
    {
        ...
        "amaura_create_program", "amaura_run_task", "amaura_supervisor_tick",
        "amaura_review_task", "amaura_pause_agent", "amaura_record_decision",
        "amaura_record_lead_evidence", "amaura_transition_lead",
        "amaura_stage_outreach", "amaura_register_content_asset",
        "amaura_record_content_metrics", "amaura_send_email",
        "amaura_update_crm", "amaura_register_venture_opportunity",
        "amaura_record_venture_metric", "amaura_cashflow_tick", "amaura_record_cashflow_financial", "amaura_execute_capability", "write_file", "edit_file",
        "run_command", "run_tests", "lint_code", "create_document",
...
__all__ = [
    "GOVERNED_ONLY_TOOLS", "READ_ONLY_TOOLS", "legacy_tool_allowed",
    "legacy_tool_mode", "unsafe_legacy_tools_exposed",
]
