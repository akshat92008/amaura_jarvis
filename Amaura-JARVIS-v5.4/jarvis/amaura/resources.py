...
RESOURCE_CATALOG: tuple[CompanyResource, ...] = (
    ...
    CompanyResource(
        ...
        "Legacy founder-handoff capability retained for Company OS compatibility. JARVIS v5.4 uses the governed official agy CLI through AntigravityDeliveryAdapter for autonomous repository engineering.",
