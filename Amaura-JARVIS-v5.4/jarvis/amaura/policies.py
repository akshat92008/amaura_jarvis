...
POLICIES: dict[str, dict[str, Any]] = {
    ...
    "external_communication": {
        "version": "1.0",
        "applies_to": ["external_proposal", "client_commitment", "draft_external"],
        "rules": [
    ...
    "pricing_and_discounts": {
        "version": "1.0",
        "applies_to": ["external_proposal", "client_commitment", "payment", "refund"],
        "rules": [
    ...
    "client_data": {
        "version": "1.0",
        "applies_to": ["client_commitment", "repository_write", "draft_external"],
        "rules": [
    ...
    "licensing": {
        "version": "1.0",
        "applies_to": ["repository_write", "research_compute", "model_release", "public_content"],
        "rules": [
    ...
    "public_claims": {
        "version": "1.0",
        "applies_to": ["public_content", "public_publish", "model_release"],
        "rules": [
    ...
    "model_evaluation": {
        "version": "1.0",
        "applies_to": ["research_compute", "model_release"],
        "rules": [
    ...
    "financial_spending": {
        "version": "1.0",
        "applies_to": ["research_compute", "payment", "refund", "repository_write"],
        "rules": [
    ...
    "content_publication": {
        "version": "1.0",
        "applies_to": ["public_content", "public_publish"],
        "rules": [
    ...
    "conflicts_of_interest": {
        "version": "1.0",
        "applies_to": ["external_proposal", "client_commitment", "public_publish"],
        "rules": [
