...
def build_parser() -> argparse.ArgumentParser:
    ...
    cashflow_add.add_argument("--opportunity-id", required=True)
    cashflow_add.add_argument("--name", required=True)
    cashflow_add.add_argument("--lane", required=True)
    cashflow_add.add_argument("--platform", required=True)
    cashflow_add.add_argument("--offer", required=True)
    cashflow_add.add_argument("--target-user", required=True)
    cashflow_add.add_argument("--distribution-channel", required=True)
    cashflow_add.add_argument("--price-cents", type=int, default=0)
    cashflow_add.add_argument("--unit-cost-cents", type=int, default=0)
    cashflow_add.add_argument("--currency", default="INR")
    cashflow_add.add_argument("--founder-minutes-per-week", type=int, default=60)
    cashflow_add.add_argument("--automation-level", type=int, default=80)
    ...
    cashflow_finance.add_argument("--source", required=True)
    cashflow_finance.add_argument("--evidence-json", required=True)
    cashflow_finance.add_argument("--currency", default="")
    ...
    cashflow_action.add_argument("--result-json", default="{}")
    cashflow_action.set_defaults(handler=command_ventures)
