"""
Backend API for feedback_hub
App Description: Customer feature request tracking and voting dashboard with FastAPI backend and React frontend
"""
...
app = FastAPI(title="feedback_hub API", version="1.0.0")
...
@app.get("/api/health")
def health_check():
    return {"status": "healthy", "app": "feedback_hub"}
