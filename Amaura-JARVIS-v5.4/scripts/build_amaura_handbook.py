...
def build_markdown() -> str:
    ...
    add(
        table(
            ...
            [
                ...
                [
                    "Applies to",
                    "The 57-role Amaura Workforce, 21 workflows, SQLite operating ledger, REST and JARVIS tool surfaces",
                ],
                [
                    "Source of truth",
                    "`jarvis/amaura/`, `jarvis/server.py`, `jarvis/tools/amaura.py`, `.env.amaura.example`, and production verification artifacts",
                ],
                [
                    "Review trigger",
                    "Any registry, workflow, policy, API, database, model-route, provider, or authority change",
                ],
                [
                    "Verified baseline",
                    "233 isolated tests passed; static checks, authenticated API smoke, deterministic wheel build, and 1,000-lead stress passed",
                ],
    ...
    add(
        table(
            ...
            [
                ...
                [
                    "API security smoke",
                    "Authenticated routes passed; missing operator authority rejected with HTTP 403",
                ],
                [
                    "Stress run",
                    "1,000 leads, 32 workers, 100/100 injections detected, 60 provider-confirmed sends, 20/20 cap violations blocked",
                ],
    ...
    add(
        table(
            ...
            [
                [
                    "Founder",
                    "Strategy, final truth, external commitments, reputation, money, critical execution",
                    "Delegate irreversible authority to an unauthenticated agent",
                ],
                [
                    "JARVIS",
                    "Programme creation, task packets, dispatch, orchestration, pause, escalation, briefing",
                    "Permit self-review or bypass the registered workflow",
                ],
                [
                    "Specialist employee",
                    "One bounded task, approved tools/data, evidence-backed output",
                    "Expand scope, exceed budget, invent facts, certify itself",
                ],
                [
                    "Independent reviewer",
                    "Acceptance criteria, evidence quality, defects and policy verification",
                    "Review its own work or approve without findings",
                ],
                [
                    "Policy engine",
                    "Deterministic allow/deny and approval requirements",
                    "Treat model text as authority",
                ],
                [
                    "External adapter",
                    "One provider action and provider-confirmed result",
                    "Claim success without provider evidence",
                ],
            ],
        )
    )
    ...
    add(
        table(
            ...
            [
                ...
                [
                    "Task packet",
                    "JARVIS-issued execution contract: objective, criteria, owner, reviewer, tools, data, budget, dependencies, model route, policies, workspace, and doctrine.",
                ],
                [
                    "Evidence",
                    "A typed, stable reference supporting a completion claim—tool output digest, source URL/excerpt, artifact hash, test result, or provider identifier.",
                ],
                [
                    "Action type",
                    "Business meaning of an action, used to load relevant policies and determine approval.",
                ],
                [
                    "Risk level",
                    "Low, medium, high, or critical. It constrains ownership, review, approval, and manual execution.",
                ],
                [
                    "Idempotency",
                    "Repeating the same request produces or returns the same governed resource instead of duplicating side effects.",
                ],
                [
                    "Kill switch",
                    "Immediate acquisition control that blocks discovery and send confirmation while preserving state.",
                ],
                [
                    "Readiness",
                    "Truthful configuration report: core checks, blockers, and optional adapter availability.",
                ],
            ],
        )
    )
    ...
    add(
        table(
            ...
            [
                [
                    "Low",
                    "Specialist executes approved tools; independent reviewer verifies",
                    "Completes after successful review unless action type is externally gated",
                ],
                ...
                [
                    "Critical",
                    "Irreversible, financial, destructive, or production-critical",
                    "Manual founder execution; autonomous tool action denied",
                ],
            ],
        )
    )
    ...
    add(
        table(
            ...
            [
                [
                    "Control plane",
                    "`jarvis/amaura/control_plane.py`",
                    "Creates hierarchy, issues task packets, dispatches, reviews, approvals, costs, pauses, decisions, dashboard and rollups.",
                ],
                [
                    "Workforce registry",
                    "`jarvis/amaura/registry.py`",
                    "43 enforceable employee envelopes: mission, tools, permission, data, budget, risk, reviewer, metrics, prompt.",
                ],
                [
                    "Workflow catalogue",
                    "`jarvis/amaura/workflows.py`",
                    "Six dependency graphs with owners, reviewers, budgets, risks, action types, and acceptance criteria.",
                ],
                [
                    "Policy engine",
                    "`jarvis/amaura/policy.py`",
                    "Assignment and tool authorization, command/path checks, secret detection, approval and completion gates.",
                ],
                [
                    "Written policies",
                    "`jarvis/amaura/policies.py`",
                    "15 policy families loaded into institutional knowledge and attached to applicable task packets.",
                ],
                [
                    "Execution runner",
                    "`jarvis/amaura/executor.py`",
                    "Runs one specialist, exposes only approved tools, captures evidence, records model cost, and submits for review.",
                ],
                [
                    "Model gateway",
                    "`jarvis/amaura/model_gateway.py`",
                    "Selects local, hybrid, or approved cloud route by sensitivity, risk, capability, and remaining budget.",
                ],
                [
                    "Company store",
                    "`jarvis/amaura/store.py`",
                    "Thread-safe SQLite ledger with WAL, foreign keys, audit, events, costs, acquisition and content records, backup and integrity check.",
                ],
                [
                    "Acquisition pipeline",
                    "`jarvis/amaura/pipeline.py`",
                    "Evidence, scoring, stage transitions, outreach approvals, limits, opt-outs, idempotency, send confirmation and kill switch.",
                ],
                [
                    "Content factory",
                    "`jarvis/amaura/content_factory.py`",
                    "Campaigns, hash-addressed assets, licensing, publication readiness and analytics windows.",
                ],
                [
                    "Security boundary",
                    "`jarvis/amaura/security.py`",
                    "Injection scan, sensitive-data scan, untrusted-data isolation, redaction and content hashing.",
                ],
                [
                    "Readiness service",
                    "`jarvis/amaura/readiness.py`",
                    "Reports actual core blockers and optional adapter availability without exposing secrets.",
                ],
                [
                    "REST server",
                    "`jarvis/server.py`",
                    "Local UI, API, auth middleware, Amaura endpoints, JARVIS endpoints and WebSocket access.",
                ],
                [
                    "JARVIS tool surface",
                    "`jarvis/tools/amaura.py`",
                    "Functions used by conversational JARVIS to operate the company OS.",
                ],
            ],
        )
    )
    ...
    add(
        table(
            ...
            [
                [
                    department_labels.get(dept, dept),
                    ", ".join(agent.name for agent in grouped[dept]),
                    str(len(grouped[dept])),
                ]
    ...
    for key, workflow in WORKFLOWS.items():
        required = (
            inline_list(workflow.required_inputs)
            if workflow.required_inputs
            else "No workflow-specific inputs beyond objective and success metric"
        )
        add(
            [
        ...
        add(
            table(
                ["#", "Stage and work", "Owner → reviewer", "Risk / budget / action", "Dependency and exit gate"], rows
            )
        )
        add([""])
        wf_counter += 1
    ...
    add(
        table(
            ...
            [[name.replace("_", " ").title(), str(limit)] for name, limit in SCORE_LIMITS.items()],
        )
    )
    add(
        [
    ...
    for source, targets in ALLOWED_TRANSITIONS.items():
        transition_rows.append(
            [
                f"`{source.value}`",
                ", ".join(f"`{target.value}`" for target in sorted(targets, key=lambda item: item.value)) or "Terminal",
            ]
        )
    ...
    add(
        table(
            ...
            [
                [
                    "`agents`",
                    "Persisted workforce definitions and enabled state",
                    "Unique agent ID; pause/resume state",
                ],
                [
                    "`work_items`",
                    "Programme/project/milestone/task hierarchy",
                    "Parent FKs, budgets, state, evidence, dependencies, metadata",
                ],
                [
                    "`approvals`",
                    "Founder decision requests",
                    "Task FK, status, decision actor/reason, immutable history",
                ],
                ...
                [
                    "`knowledge`",
                    "Versioned institutional knowledge and policy material",
                    "Namespace/key identity, evidence refs, sensitivity",
                ],
                ...
                [
                    "`leads`",
                    "Prospect state and commercial fields",
                    "Unique normalized domain; score and do-not-contact constraints",
                ],
                ["`lead_evidence`", "Source-linked prospect claims", "Confidence, content hash, uniqueness"],
                [
                    "`messages`",
                    "Exact outbound drafts and provider confirmations",
                    "Unique idempotency key and provider message ID",
                ],
                [
                    "`pipeline_events`",
                    "Acquisition audit/event ledger",
                    "Input hash, output, agent, lead and campaign linkage",
                ],
                ...
                [
                    "`content_assets`",
                    "Hash-addressed content and licence inventory",
                    "Unique campaign/type/hash and approval status",
                ],
    ...
    add(
        table(
            ...
            [
                [
                    "Sensitivity is client-confidential, secret, or restricted",
                    "`ollama-local`",
                    "None",
                    "Device-only; failure stops the task",
                ],
                [
                    "Vision required",
                    "`llama-vision` through approved NVIDIA route",
                    "`llama-3.3-70b`",
                    "Cloud-approved data only",
                ],
                [
                    "Balanced agent or high/critical reasoning",
                    "`fable-5-reasoning` hybrid",
                    "`llama-3.3-70b`",
                    "Cloud-approved data only",
                ],
        ...
        table(
            ...
            [
                [
                    risk,
                    {
                        "R0": "Read-only local context",
                        "R1": "External/public retrieval",
                        "R2": "Workspace mutation or local execution",
        ...
        table(
            ...
            [
                ...
                [
                    "`TELEGRAM_USER_ID`",
                    "Optional",
                    "Authorized Telegram founder identity; approval buttons stay disabled without it",
                ],
            ],
        )
    )
        ...
        table(
            ...
            [
                ...
                [
                    ...
                    "Inspect schemas and execute REST calls",
                ],
    ...
    add(
        table(
            ...
            [
                [
                    "`X-Amaura-Operator-Key`",
                    "Detailed reads, programme/task operations, campaigns, leads, evidence, metrics and send confirmation",
                    "Founder approval decisions",
                ],
                [
                    "`X-Amaura-Approval-Key`",
                    "Company approvals, exact message decisions, acquisition kill switch",
                    "Routine operator calls",
                ],
                [
                    "`X-JARVIS-API-Key`",
                    "General JARVIS mutations/remote-mode access where required",
                    "Replacing the two Amaura authority keys",
                ],
            ],
        )
    )
    ...
    add(
        table(
            ...
            [
                [
                    "Readiness",
                    "`ready: true`, core operational, no unexpected blocker",
                    "Any key, binding, database, registry, prompt, or workflow check fails",
                ],
                [
                    "Task age",
                    "Dependency-ready work advances within the operating window",
                    "Stalled ≥24 hours without recorded reason",
                ],
                ["Budget", "Spend stays below task limit", "80% alert, repeated underestimation, or denied overrun"],
                [
                    "Review",
                    "Independent findings and evidence",
                    "Self-review attempt, repeated rejection, unsupported completion",
                ],
                [
                    "Acquisition",
                    "Caps respected, exact approvals, provider-confirmed sends, opt-outs terminal",
                    "Duplicate/unsourced contact, cap pressure, stale approvals, opt-out attempt",
                ],
                [
                    "Content",
                    "All required approved assets, valid licences, exact hashes",
                    "Missing claim map/licence/QA, duplicate hash, public action without approval",
                ],
                [
                    "Security",
                    "No secrets in payloads/logs; injection findings isolated",
                    "Secret scan, path escape, unsafe command, suspicious external content",
                ],
                [
                    "Database",
                    "Integrity `ok`, no FK violations, WAL",
                    "Any integrity failure or unexpected journal mode",
                ],
            ],
        )
    )
        ...
        table(
            ...
            [
                ...
                [
                    "`inputs`",
                    "Depends",
                    "Workflow inputs plus valid workspace/repository path and optional sensitivity",
                ],
            ],
        )
    )
        ...
        table(
            ...
            [
                [
                    item.name,
                    f"`{item.probe}`",
                    "Yes" if item.required_for_core else "No",
                    {
    ...
    add(
        table(
            ...
            [
                ...
                [
                    "1 — Draft",
                    "Create Gmail/platform/private draft only",
                    "Exact payload, provider draft ID, least privilege, no public/send action",
                ],
                [
                    "2 — Founder-triggered",
                    "Founder clicks/executes exact approved action",
                    "Identity check, exact hash/message, provider ID, audit",
                ],
                [
                    "3 — Bounded automation",
                    "Low-volume approved adapter under caps",
                    "Sandbox history, idempotency, opt-out, rollback, alerting, error injection",
                ],
                [
                    "4 — Expanded",
                    "Higher controlled volume or more channels",
                    "Measured safety/quality, legal/platform review, incident drills, founder approval",
                ],
            ],
        )
    )
    ...
    add(
        table(
            ...
            [
                [
                    "HTTP 503 on protected route",
                    "Authority key not configured",
                    "Set the correct 24+ character environment key and restart",
                ],
                [
                    "HTTP 403",
                    "Wrong header or mismatched key",
                    "Use operator vs approval header correctly; compare environment; do not log values",
                ],
                [
                    "Readiness false",
                    "One or more blockers",
                    "Read the `blockers` array; correct key separation, binding, database, registry, prompt, or workflow check",
                ],
                [
                    "Task becomes blocked at start",
                    "Dependency incomplete or employee paused",
                    "Complete/review/approve upstream dependency or resolve pause",
                ],
                [
                    "Task cannot run",
                    "Wrong state, missing model/provider, exhausted budget",
                    "Inspect task packet, state, route, budget, and provider health",
                ],
                [
                    "Restricted task fails",
                    "Ollama/model unavailable",
                    "Start Ollama and install/configure `AMAURA_LOCAL_MODEL`; no cloud fallback is allowed",
                ],
                [
                    "Tool denied",
                    "Not approved, wrong owner/state, unsafe command, path escape, secret, or R3/R4",
                    "Narrow the action; use task workspace and allowed command; remove secret; use approval adapter",
                ],
                [
                    "Review denied",
                    "Actor is not registered reviewer, self-review, wrong state, or no findings",
                    "Use exact reviewer and provide concrete findings",
                ],
                [
                    "Lead rejected as duplicate",
                    "Normalized domain already exists",
                    "Use existing record; do not create another identity",
                ],
                [
                    "Lead score rejected",
                    "Missing/extra component or out-of-range/non-integer value",
                    "Supply exactly the five bounded integers",
                ],
                [
                    "Message staging rejected",
                    "No evidence, low score, opt-out/terminal state, wrong length, follow-up maximum",
                    "Correct the underlying governance failure; do not bypass",
                ],
                ["Message marked stale", "Approval older than 48 hours", "Create/review a fresh exact draft"],
                [
                    "Send confirmation rejected",
                    "Not approved, no provider ID, cap exceeded, opt-out, kill switch",
                    "Do not claim send; resolve valid cause or wait for cap window",
                ],
                [
                    "Content readiness false",
                    "Missing approved type, licence issue, or duplicate hash",
                    "Register/approve unique required assets with complete source/licence",
                ],
                [
                    "Database integrity fails",
                    "Storage corruption or invalid external modification",
                    "Stop writes, preserve evidence, restore verified backup, investigate root cause",
                ],
            ],
        )
    )
    ...
    add(
        table(
            ...
            [
                ...
                [
                    "Approval adapter",
                    "Authenticated component that performs one exact founder-approved external action.",
                ],
...
def add_cover(doc: Document) -> None:
    ...
    r = p.add_run(
        "43 governed AI employees  •  6 workflows  •  Founder-gated external authority  •  Evidence-first operations"
    )
    r.font.size = Pt(11)
