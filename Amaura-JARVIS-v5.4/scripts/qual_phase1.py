...
def run_phase1():
    ...
    write_ev("E-BUILD-001.txt", f"EVIDENCE ID: E-BUILD-001\nCLAIM: Record build ID A\nBUILD_ID: {build_id_a}\nJSON: {health_a}")
    ...
    write_ev("E-BUILD-002.txt", f"EVIDENCE ID: E-BUILD-002\nCLAIM: Old backend still reports A\nEXPECTED: {build_id_a}\nACTUAL: {build_id_a2}\nJSON: {health_a2}")
    ...
    write_ev("E-BUILD-003.txt", f"EVIDENCE ID: E-BUILD-003\nCLAIM: New backend reports B\nEXPECTED: {new_tree}\nACTUAL: {build_id_b}\nJSON: {health_b}")
