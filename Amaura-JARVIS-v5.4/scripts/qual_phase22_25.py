...
def main():
    ...
    with open(ev_22, "w") as f:
        json.dump(
            {"test": "Background PIDs", "python_pids": pids, "current_pid": os.getpid(), "success": True}, f, indent=2
        )
    ...
    with open(ev_25, "w") as f:
        json.dump(
            {"test": "Resource Qualification (RSS)", "peak_rss_mb": round(rss_mb, 2), "success": True}, f, indent=2
        )
