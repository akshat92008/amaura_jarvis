...
def main():
    ...
    response = agent.run_non_interactive("Use your automate_macos_app tool to write an AppleScript that returns the version of Mail. You must actually use the tool.")
    print("\nJARVIS Response:")
    print(response)
