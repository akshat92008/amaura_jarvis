...
| routing_02_latency_5x | No | PASS_REAL_TOOL_E2E | median=17ms, max=20ms |
...
| soak_30_tasks | Yes | PASS_REAL_BLACKBOX_E2E | 28/30 passed (93.3%), rss_max=97MB |
| concurrent_2_tasks | Yes | FAIL | all_200=True, contaminated=True, total=74ms |
| concurrent_5_tasks | Yes | FAIL | all_200=True, contaminated=True, total=133ms |
